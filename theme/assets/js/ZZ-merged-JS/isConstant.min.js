 ...
 *  Under MIT License
 */
!function(a,b){"function"==typeof define&&define.amd?define(["jquery"],function(c){return b(a,c)}):"object"==typeof exports?b(a,require("jquery")):b(a,a.jQuery||a.Zepto)}(this,function(a,b){"use strict";function c(a){if(w&&"none"===a.css("animation-name")&&"none"===a.css("-webkit-animation-name")&&"none"===a.css("-moz-animation-name")&&"none"===a.css("-o-animation-name")&&"none"===a.css("-ms-animation-name"))return 0;var b,c,d,e,f=a.css("animation-duration")||a.css("-webkit-animation-duration")||a.css("-moz-animation-duration")||a.css("-o-animation-duration")||a.css("-ms-animation-duration")||"0s",g=a.css("animation-delay")||a.css("-webkit-animation-delay")||a.css("-moz-animation-delay")||a.css("-o-animation-delay")||a.css("-ms-animation-delay")||"0s",h=a.css("animation-iteration-count")||a.css("-webkit-animation-iteration-count")||a.css("-moz-animation-iteration-count")||a.css("-o-animation-iteration-count")||a.css("-ms-animation-iteration-count")||"1";for(f=f.split(", "),g=g.split(", "),h=h.split(", "),e=0,c=f.length,b=Number.NEGATIVE_INFINITY;c>e;e++)d=parseFloat(f[e])*parseInt(h[e],10)+parseFloat(g[e]),d>b&&(b=d);return d}function d(){if(b(document.body).height()<=b(window).height())return 0;var a,c,d=document.createElement("div"),e=document.createElement("div");return d.style.visibility="hidden",d.style.width="100px",document.body.appendChild(d),a=d.offsetWidth,d.style.overflow="scroll",e.style.width="100%",d.appendChild(e),c=e.offsetWidth,d.parentNode.removeChild(d),a-c}function e(){var a,c,e=b("html"),f=k("is-locked");e.hasClass(f)||(c=b(document.body),a=parseInt(c.css("padding-right"),10)+d(),c.css("padding-right",a+"px"),e.addClass(f))}function f(){var a,c,e=b("html"),f=k("is-locked");e.hasClass(f)&&(c=b(document.body),a=parseInt(c.css("padding-right"),10)-d(),c.css("padding-right",a+"px"),e.removeClass(f))}function g(a,b,c,d){var e=k("is",b),f=[k("is",u.CLOSING),k("is",u.OPENING),k("is",u.CLOSED),k("is",u.OPENED)].join(" ");a.$bg.removeClass(f).addClass(e),a.$overlay.removeClass(f).addClass(e),a.$wrapper.removeClass(f).addClass(e),a.$modal.removeClass(f).addClass(e),a.state=b,!c&&a.$modal.trigger({type:b,reason:d},[{reason:d}])}function h(a,d,e){var f=0,g=function(a){a.target===this&&f++},h=function(a){a.target===this&&0===--f&&(b.each(["$bg","$overlay","$wrapper","$modal"],function(a,b){e[b].off(r+" "+s)}),d())};b.each(["$bg","$overlay","$wrapper","$modal"],function(a,b){e[b].on(r,g).on(s,h)}),a(),0===c(e.$bg)&&0===c(e.$overlay)&&0===c(e.$wrapper)&&0===c(e.$modal)&&(b.each(["$bg","$overlay","$wrapper","$modal"],function(a,b){e[b].off(r+" "+s)}),d())}function i(a){a.state!==u.CLOSED&&(b.each(["$bg","$overlay","$wrapper","$modal"],function(b,c){a[c].off(r+" "+s)}),a.$bg.removeClass(a.settings.modifier),a.$overlay.removeClass(a.settings.modifier).hide(),a.$wrapper.hide(),f(),g(a,u.CLOSED,!0))}function j(a){var b,c,d,e,f={};for(a=a.replace(/\s*:\s*/g,":").replace(/\s*,\s*/g,","),b=a.split(","),e=0,c=b.length;c>e;e++)b[e]=b[e].split(":"),d=b[e][1],("string"==typeof d||d instanceof String)&&(d="true"===d||("false"===d?!1:d)),("string"==typeof d||d instanceof String)&&(d=isNaN(d)?d:+d),f[b[e][0]]=d;return f}function k(){for(var a=q,b=0;b<arguments.length;++b)a+="-"+arguments[b];return a}function l(){var a,c,d=location.hash.replace("#","");if(d){try{c=b("[data-"+p+"-id="+d.replace(new RegExp("/","g"),"\\/")+"]")}catch(e){}c&&c.length&&(a=b[p].lookup[c.data(p)],a&&a.settings.hashTracking&&a.open())}else n&&n.state===u.OPENED&&n.settings.hashTracking&&n.close()}function m(a,c){var d=b(document.body),e=this;e.settings=b.extend({},t,c),e.index=b[p].lookup.push(e)-1,e.state=u.CLOSED,e.$overlay=b("."+k("overlay")),e.$overlay.length||(e.$overlay=b("<div>").addClass(k("overlay")+" "+k("is",u.CLOSED)).hide(),d.append(e.$overlay)),e.$bg=b("."+k("bg")).addClass(k("is",u.CLOSED)),e.$modal=a.addClass(q+" "+k("is-initialized")+" "+e.settings.modifier+" "+k("is",u.CLOSED)).attr("tabindex","-1"),e.$wrapper=b("<div>").addClass(k("wrapper")+" "+e.settings.modifier+" "+k("is",u.CLOSED)).hide().append(e.$modal),d.append(e.$wrapper),e.$wrapper.on("click."+q,"[data-"+p+'-action="close"]',function(a){a.preventDefault(),e.close()}),e.$wrapper.on("click."+q,"[data-"+p+'-action="cancel"]',function(a){a.preventDefault(),e.$modal.trigger(v.CANCELLATION),e.settings.closeOnCancel&&e.close(v.CANCELLATION)}),e.$wrapper.on("click."+q,"[data-"+p+'-action="confirm"]',function(a){a.preventDefault(),e.$modal.trigger(v.CONFIRMATION),e.settings.closeOnConfirm&&e.close(v.CONFIRMATION)}),e.$wrapper.on("click."+q,function(a){var c=b(a.target);c.hasClass(k("wrapper"))&&e.settings.closeOnOutsideClick&&e.close()})}var n,o,p="remodal",q=a.REMODAL_GLOBALS&&a.REMODAL_GLOBALS.NAMESPACE||p,r=b.map(["animationstart","webkitAnimationStart","MSAnimationStart","oAnimationStart"],function(a){return a+"."+q}).join(" "),s=b.map(["animationend","webkitAnimationEnd","MSAnimationEnd","oAnimationEnd"],function(a){return a+"."+q}).join(" "),t=b.extend({hashTracking:!0,closeOnConfirm:!0,closeOnCancel:!0,closeOnEscape:!0,closeOnOutsideClick:!0,modifier:""},a.REMODAL_GLOBALS&&a.REMODAL_GLOBALS.DEFAULTS),u={CLOSING:"closing",CLOSED:"closed",OPENING:"opening",OPENED:"opened"},v={CONFIRMATION:"confirmation",CANCELLATION:"cancellation"},w=function(){var a=document.createElement("div").style;return void 0!==a.animationName||void 0!==a.WebkitAnimationName||void 0!==a.MozAnimationName||void 0!==a.msAnimationName||void 0!==a.OAnimationName}();m.prototype.open=function(){var a,c=this;c.state!==u.OPENING&&c.state!==u.CLOSING&&(a=c.$modal.attr("data-"+p+"-id"),a&&c.settings.hashTracking&&(o=b(window).scrollTop(),location.hash=a),n&&n!==c&&i(n),n=c,e(),c.$bg.addClass(c.settings.modifier),c.$overlay.addClass(c.settings.modifier).show(),c.$wrapper.show().scrollTop(0),c.$modal.focus(),h(function(){g(c,u.OPENING)},function(){g(c,u.OPENED)},c))},m.prototype.close=function(a){var c=this;c.state!==u.OPENING&&c.state!==u.CLOSING&&(c.settings.hashTracking&&c.$modal.attr("data-"+p+"-id")===location.hash.substr(1)&&(location.hash="",b(window).scrollTop(o)),h(function(){g(c,u.CLOSING,!1,a)},function(){c.$bg.removeClass(c.settings.modifier),c.$overlay.removeClass(c.settings.modifier).hide(),c.$wrapper.hide(),f(),g(c,u.CLOSED,!1,a)},c))},m.prototype.getState=function(){return this.state},m.prototype.destroy=function(){var a,c=b[p].lookup;i(this),this.$wrapper.remove(),delete c[this.index],a=b.grep(c,function(a){return!!a}).length,0===a&&(this.$overlay.remove(),this.$bg.removeClass(k("is",u.CLOSING)+" "+k("is",u.OPENING)+" "+k("is",u.CLOSED)+" "+k("is",u.OPENED)))},b[p]={lookup:[]},b.fn[p]=function(a){var c,d;return this.each(function(e,f){d=b(f),null==d.data(p)?(c=new m(d,a),d.data(p,c.index),c.settings.hashTracking&&d.attr("data-"+p+"-id")===location.hash.substr(1)&&c.open()):c=b[p].lookup[d.data(p)]}),c},b(document).ready(function(){b(document).on("click","[data-"+p+"-target]",function(a){a.preventDefault();var c=a.currentTarget,d=c.getAttribute("data-"+p+"-target"),e=b("[data-"+p+"-id="+d+"]");b[p].lookup[e.data(p)].open()}),b(document).find("."+q).each(function(a,c){var d=b(c),e=d.data(p+"-options");e?("string"==typeof e||e instanceof String)&&(e=j(e)):e={},d[p](e)}),b(document).on("keydown."+q,function(a){n&&n.settings.closeOnEscape&&n.state===u.OPENED&&27===a.keyCode&&n.close()}),b(window).on("hashchange."+q,l)})});var G_screen_width=$(window).width(),G_screen_height=$(window).height(),G_page_height=getPageHeight(),G_header_height=$(".progressBar").height()+$(".headerTools__title").height(),G_buffer_higher=parseInt(.25*G_screen_height),G_buffer_high=parseInt(.33*G_screen_height),G_buffer_low=parseInt(.66*G_screen_height),G_buffer_lower=parseInt(.75*G_screen_height),G_onResize=[],G_onScrollStop=[];$(window).resize(function(){G_screen_width=$(window).width(),G_screen_height=$(window).height(),G_page_height=$('[data-jshook*="siteContainer"]').outerHeight(),G_buffer_higher=parseInt(.25*G_screen_height),G_buffer_high=parseInt(.33*G_screen_height),G_buffer_low=parseInt(.66*G_screen_height),G_buffer_lower=parseInt(.75*G_screen_height),clearTimeout(window.resizedFinished),window.resizedFinished=setTimeout(function(a,b){$.each(G_onResize,function(){"undefined"!=typeof b&&b.call()})},250)});var G_scrollPos=$(document).scrollTop(),willChangeElement=$(".TK-willChange"),willChangeClass="TK-willChange--isApplied-JS";$(window).scroll(function(a){G_scrollPos=$(document).scrollTop(),G_screen_height+300>G_scrollPos?willChangeElement.not("."+willChangeClass).addClass(willChangeClass):willChangeElement.filter("."+willChangeClass).removeClass(willChangeClass),clearTimeout(window.scrolling),window.scrolling=setTimeout(function(){$.each(G_onScrollStop,function(a,b){"undefined"!=typeof b&&b.call()})},250)}),G_onScrollStop.push(function(){willChangeElement.filter("."+willChangeClass).removeClass(willChangeClass)});var bp={tiny:350,small:480,mobile:600,mid:770,tablet:960,large:1024,page:1200},G_countUpOptions={useEasing:!0,useGrouping:!0,separator:",",decimal:".",prefix:"",suffix:""},globals={fullScreen_filler:"fullScreen__filler",fullScreen_subtractor:"fullScreen__subtractor",fullScreen_isApplied:"fullScreen__filler--isApplied-JS"},MQG_home_is_scrollAnimated=G_screen_width>bp.page,G_siteTitle=$("title").text().split("| ").pop(),G_pageTitle=$("title").text().split(" |")[0],module="",moduleTargets={},Class=function(a,b){b=applyClassSet(b);var c="";return a.constructor===Array?$.each(a,function(a,d){var e=0==a?"":", ";c=c+e+"."+b[d]}):c="."+b[a],c},Span=function(a,b){return b=applyClassSet(b),b[a]},Hook=function(a,b){b=applyClassSet(b);var c="",d=[],e=function(a,c){switch(a){case 0:var d='[data-jshook^="'+b[c]+' "]';break;case 1:var d='[data-jshook*=" '+b[c]+' "]';break;case 2:var d='[data-jshook$=" '+b[c]+'"]';break;case 3:var d='[data-jshook="'+b[c]+'"]';break;case 4:var d='[data-jshook*="'+b[c]+'"]'}return d},f=function(a){return e(0,a)+","+e(1,a)+","+e(2,a)+","+e(3,a)};return a.constructor===Array?($.each(a,function(a,b){var g="";if(b.constructor===Array)$.each(b,function(a,b){g+=e(4,b)}),d[a]=g;else{var h=0==a?"":", ";c=c+h+f(b)}}),$.each(d,function(a,b){var d=0==a?"":", ";c=c+d+b})):c=f(a),c},id=function(a,b){b=applyClassSet(b);var c="";return a.constructor===Array?$.each(a,function(a,d){var e=0==a?"":", ";c=c+e+"#"+b[d]}):c="#"+b[a],c};jQuery.fn.modAddClass=function(a,b){return b=applyClassSet(b),this.addClass(grabClasses(a,b)),this},jQuery.fn.modRemoveClass=function(a,b){return b=applyClassSet(b),this.removeClass(grabClasses(a,b)),this},jQuery.fn.modToggleClass=function(a,b){return b=applyClassSet(b),this.toggleClass(grabClasses(a,b)),this},jQuery.fn.modHasClass=function(a,b,c){if(c=applyClassSet(c),b=defaultTo(b,"and"),a.constructor===Array){var d="";return $.each(a,function(a,e){var f="";"or"==b&&0!=a?f=", ":"and"==b&&0!=a&&(f=0==a?"":" "),d=d+f+Class(e,c)}),this.is(d)}return c=defaultTo(c,b),this.hasClass(Span(a,c))},jQuery.fn.modHasHook=function(a,b){b=applyClassSet(b);var c=this.attr("data-jshook");return c.indexOf(Span(a,b))>0},$.fn.moveTo=function(a,b){if(a="string"==typeof a?$(a):a,"undefined"!=typeof a)switch(b){case"prepend":a.prepend(this);break;case"before":a.before(this);break;case"after":a.after(this);break;default:a.append(this)}return this},$.fn.stage=function(a,b){self=this;var c=self.attr("data-current-stage");return c==a&&b.call(self),self},$.fn.addTimer=function(a){a=defaultTo(a,{repeatedElement:!1});var b=this;setTimeout(function(){b.addClass("stage-"+a.classNumber+"-JS").attr("data-current-stage",a.classNumber),b[0].className=b[0].className.replace(/\bcurrentStage.[0-9]*-JS\b/g,""),b.addClass("currentStage-"+a.classNumber+"-JS"),0!=a.repeatedElement&&$(a.repeatedElement).eq(a.classNumber-1).addClass(a.activationName),0!=a.callback&&a.callback.call(b,a.classNumber)},1e3*a.time)},$.fn.addStages=function(a,b,c){if(a=defaultTo(a,{startAt:1,stages:[],callback:!1,repeatedElement:!1}),this.length&&!this.hasClass("stage-1-JS")){var d=(this.length,this);a.stages.unshift(0),d.each(function(){$.each(a.stages,function(e){d.addTimer({time:a.stages[e],classNumber:a.startAt+e,callback:a.callback,repeatedElement:b,activationName:c})})})}return this},$.fn.rapidStages=function(a){a=defaultTo(a,{startAt:1,repeatedElement:"> *",activationName:"stage__element--isActivated-JS",startStages:[],startTime:0,delay:.2,endStages:[],callback:!1});var b=this,c=b.find(a.repeatedElement),d=a.startStages;return c.each(function(e){d.push(a.startTime+a.delay*e),isLastRound(e,c)&&($.merge(d,a.endStages),b.addStages({startAt:a.startAt,stages:d,callback:a.callback},c,a.activationName))}),this},$.fn.removeStages=function(a){return activationClass=defaultTo(a,"stage__element--isActivated-JS"),this[0].className=this[0].className.replace(/\bcurrentStage.[0-9]*-JS\b/g,"").replace(/\bstage.[0-9]*-JS\b/g,""),this.find("."+activationClass).removeClass(activationClass),this},$("iframe").length&&$("iframe").each(function(){var a=$(this).attr("src");b=-1===a.indexOf("?")?"?":"&",$(this).attr("src",a+b+"wmode=transparent")}),function(a){a(document).on("keyup",function(b){27==b.which&&a("body").click()}),a.fn.outsideClick=function(b,c){var d=this,e="undefined"!=typeof c,f="ontouchend"in document?"touchend":"click";return a("body").on(f,function(f){var g,h=!a(f.target).closest(d).length,i=a(f.target).closest(c).length;g=e?h&&!i:h,g&&b.call(d,f)}),this}}(jQuery),jQuery.fn.scrollToMe=function(a){var b=this;if(a=defaultTo(a,{target:b}),b.length){var c=b.offset().top;scrollTo(c,a)}return this},jQuery.fn.scrollToTarget=function(a){return this.click(function(){$($(this).attr("href")).scrollToMe(a)}),this},$('a[href^="#"]').not("[data-jshook]").scrollToTarget();var hash=window.location.hash;hash.length&&hash.indexOf("lightbox__")<1&&$(window.location.hash).scrollToMe(),$(window).on("mousewheel",function(){$("html, body").stop(),G_autoScroll__isPlaying=!1}),$.fn.swapTooltip=function(){return this.toggleClass("tooltipSwap--swapped-JS"),this},$.fn.waitForMe=function(a,b,c){c=defaultTo(c,1e4),b=defaultTo(b,10);var d=this.selector,e=0,f=setInterval(function(){if($(d).length)clearInterval(f),a.call($(d));else if(e>=c)throw clearInterval(f),"Error: "+d+" was not found or failed to load.";e+=b},b);return this},jQuery(function(a){function b(a,b,c){var d=a.replace(/(\r\n|\n|\r)/gm,"").trim(),e=b.replace(/(\r\n|\n|\r)/gm,"").trim().toLowerCase(),f=c.replace(/(\r\n|\n|\r)/gm,"").trim();try{ga("send","event",d,e,f)}catch(g){}}function c(b){return module=p,a(Hook("visShifter")).modHasClass("isHidden_"+b)}moduleTargets=moduleTargets||{};var d="screenFader";module=d,moduleTargets[module]={module:module};var e=function(b,c){module=d,c=defaultTo(c,1e3);var e={"in":function(b){a(Hook("module")).fadeIn(b)},out:function(b){a(Hook("module")).fadeOut(b)}};e[b](c)};a(Hook("module")).length&&(a(Hook("fullScreen_filler",globals)).length?a(Class("fullScreen_isApplied",globals)).waitForMe(function(){e("out")}):e("out"));var f="accordion";module=f,moduleTargets[module]={item:module+"__item",trigger_manual:module+"__trigger--manual",trigger_auto:module+"__trigger--auto",reference:module+"__reference",content:module+"__content",heading:module+"__heading",item_isOpen:module+"__item--isOpen-JS"},a(Hook("content")).length&&(a(Hook("trigger_manual")).on("click",function(b){module=f,preventDefault(b);var c=a(this).attr("href"),d=a(this).closest(Hook("item"));a(c).children(Hook("content")).slideToggle(),d.modToggleClass("item_isOpen")}),a(Hook("trigger_auto")).click(function(b){module=f,preventDefault(b);var c=a(this).attr("href"),d=a(c).find(Hook("content")),e=a(a(this).attr("href")),g=a(this).closest(Hook("reference"));d.is(":visible")?(d.slideUp(),e.modRemoveClass("item_isOpen")):(g.find(Hook("item")).not(a(this)).modRemoveClass("item_isOpen").end().find(Hook("content")+":visible").not(c).slideUp().end(),g.find(Hook("heading")).slideDown(),e.modAddClass("item_isOpen").find(Hook("content")).slideDown().end().find(Hook("heading")).slideUp())})),a.fn.fillScreen=function(b){var c=this;c.each(function(c){a(this).modRemoveClass("fullScreen_isApplied",globals);var d=a(b),e=a(this).attr("data-fullscreen-subtract")||0,f=d.length?d.height():0;a(this).css("min-height",G_screen_height-f-e).modAddClass("fullScreen_isApplied",globals)})};var g=a(Hook("fullScreen_filler",globals)),i=a(Hook("fullScreen_subtractor",globals));g.fillScreen(i),G_onResize.push(function(){g.fillScreen(i)});var j="infoTip";module=j,moduleTargets[module]={trigger:module+"__trigger",close:module+"__close",isClosed:module+"--isClosed-JS",isOpen:module+"--isOpen-JS"},a(Hook("trigger")).click(function(b){module=j,a(this).modAddClass("isOpen").modRemoveClass("isClosed"),b.stopPropagation()}).outsideClick(function(){module=j,a(this).modHasClass("isOpen")&&a(this).modAddClass("isClosed").modRemoveClass("isOpen")}),a(Hook("close")).click(function(b){module=j,a(this).closest(Hook("trigger")).modAddClass("isClosed").modRemoveClass("isOpen"),b.stopPropagation()});var k=G_scrollPos;a(document).on("opening","[data-remodal-id]",function(){k=G_scrollPos}).on("closing","[data-remodal-id]",function(b){e("in",250),a("body").css({position:"relative",top:-G_scrollPos}),scrollTo(k,{duration:0})}).on("closed","[data-remodal-id]",function(b){setTimeout(function(){a("body, html").removeAttr("style"),scrollTo(k,{duration:0}),setTimeout(function(){e("out",250)},250)},0)});var l=["pdf","doc","docx","xls","xlsx","ppt","pptx","txt","mp3"],m=["jpg","gif","png"];a('a:not([href^="javascript"])').each(function(c){var d=a(this).attr("href");if("undefined"!=typeof d){var e=d.substr(d.lastIndexOf(".")+1).toLowerCase();a.inArray(e,l)>-1?a(this).addClass("downloadLink-JS").addClass("downloadLink--"+e+"-JS"):a.inArray(e,m)>-1&&a("html").hasClass("touch")&&a(this).addClass("imageLink-JS");var f=d.match("^http://www.linkedin.com"),g=d.match("^http://twitter.com/intent/tweet"),i=d.match("^http://www.facebook.com/sharer"),j=d.match("^mailto:?");baseShareClass="shareLink",(f||g||i)&&a(this).addClass(baseShareClass+"-JS"),f?a(this).addClass(baseShareClass+"--linkedIn-JS"):g?a(this).addClass(baseShareClass+"--twitter-JS"):i?a(this).addClass(baseShareClass+"--facebook-JS"):j&&a(this).addClass("emailShare-JS"),d.match("^http://www.itunes.com")&&a(this).addClass("podcastLink-JS"),!d.match("^http")||-1!==d.indexOf(window.location.host)||a(this).hasClass("shareLink-JS")||a(this).hasClass("podcastLink-JS")||a(this).addClass("externalLink-JS")}if(c==a('a:not([href^="javascript"])').length-1){var k=".downloadLink-JS, .imageLink-JS, .externalLink-JS, .podcastLink-JS";a("body").on("click",".downloadLink-JS",function(){var c=a(this).attr("href"),d="downloadLink--",e=a(this),f=e.text();a.each(l,function(a){var g=l[a];e.hasClass(d+g+"-JS")&&b("Download - "+g,"click",G_pageTitle+" | "+f+" | "+c)})}),a("body").on("click",".externalLink-JS",function(){var c=a(this).attr("href");b("Outbound","click",G_pageTitle+" | "+c)}),a("body").on("click",".podcastLink-JS",function(){var c=a(this).attr("href");b("Podcast","click",G_pageTitle+" | "+c)}),a("body").on("click",".emailShare-JS",function(){b("Email share","click",G_pageTitle)}),a("body").on("click",".shareLink-JS",function(c){preventDefault(c);var d=a(this).attr("href"),e="shareLink--";if(a(this).hasClass(e+"twitter-JS")){var f="Share on Twitter",g=600,i=260;b("Twitter share","click",G_pageTitle)}else if(a(this).hasClass(e+"linkedIn-JS")){var f="Share on LinkedIn",g=600,i=400;b("LinkedIn share","click",G_pageTitle)}else if(a(this).hasClass(e+"facebook-JS")){var f="Share on Facebook",g=600,i=400;b("Facebook share","click",G_pageTitle)}var j=void 0!=window.screenLeft?window.screenLeft:screen.left,k=void 0!=window.screenTop?window.screenTop:screen.top;w=window.innerWidth?window.innerWidth:document.documentElement.clientWidth?document.documentElement.clientWidth:screen.width,h=window.innerHeight?window.innerHeight:document.documentElement.clientHeight?document.documentElement.clientHeight:screen.height;var l=w/2-g/2+j,m=h/2-i/2+k;window.open(d,f,"scrollbars=yes, width="+g+", height="+i+", top="+m+", left="+l)}),a(k).addClass("newWindow-JS"),a("body").on("click",k,function(b){preventDefault(b),window.open(a(this).attr("href"))})}});var n="popins";module=n,moduleTargets[module]={popins:module,isActivated:module+"__item--isActivated-JS"},a(Hook("popins")).each(function(){var b=a(this);new ScrollMagic.Scene({triggerElement:this}).on("enter",function(){module=n,b.rapidStages({activationName:Span("isActivated")})}).on("leave",function(){module=n}).addTo(G_ctrl)});var o="skipLinks";module=o,moduleTargets[module]={link:module+"__link",nextContentBlock:module+"__nextContentBlock",skipToNav:module+"__skipToNav",sideNav:module+"__sideNav",target:module+"__target"},a(Hook("nextContentBlock")).last().remove(),a(Hook("sideNav")).length||a(Hook("skipToNav")).remove(),a(Hook("link")).scrollToTarget();var p="socialShare";if(module=p,moduleTargets[module]={visShifter:module+"__visShifter",visScrollTrigger:module+"__visScrollTrigger",visBtnTrigger_hide:module+"__visBtnTrigger--hide",visBtnTrigger_show:module+"__visBtnTrigger--show",visBtnTrigger_toggle:module+"__visBtnTrigger--toggle",isHidden_btn:module+"__visShifter--isBtnHidden-JS",isHidden_scroll:module+"__visShifter--isScrollHidden-JS"},a(Hook("visBtnTrigger_hide")).click(function(){module=p,c("scroll")||a(Hook("visShifter")).modAddClass("isHidden_btn").fadeOut()}),a(Hook("visBtnTrigger_show")).click(function(){module=p,c("scroll")||a(Hook("visShifter")).modRemoveClass("isHidden_btn").fadeIn()}),a(Hook("visBtnTrigger_toggle")).click(function(){module=p,c("scroll")||a(Hook("visShifter")).modToggleClass("isHidden_btn").fadeToggle()}),a(Hook("visScrollTrigger")).length){new ScrollMagic.Scene({triggerElement:Hook("visScrollTrigger"),triggerHook:"onEnter"}).on("enter",function(){module=p,c("btn")||a(Hook("visShifter")).modAddClass("isHidden_scroll").fadeOut()}).on("leave",function(){module=p,c("btn")||a(Hook("visShifter")).modRemoveClass("isHidden_scroll").fadeIn()}).addTo(G_ctrl)}a("table").length&&a("table").wrap('<div class="tableWrap-JS"></div>'),a('[data-jshook*="tiltParallax__scene"]').parallax();var q="videoBlock";module=q,moduleTargets[module]={playBtn:module+"__playBtn",overlay:module+"__overlay",overlay_isClosed:module+"__overlay--isClosed-JS"},a(Hook("playBtn")).click(function(b){module=q,preventDefault(b),targetID=a(this).attr("href").substr(1),callPlayer(targetID,function(){callPlayer(targetID,"playVideo")}),a(Hook("overlay")).modAddClass("overlay_isClosed")})});