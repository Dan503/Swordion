...
It has been spilt into sperate files holding the navigation for each of the main content segments. The file name isn't importnat other than the number. The number dictates the order that nav appears in.
...
This is a list of all current attributes:

'title' => [string] title of the page [required]
'link' => [string/array] overide the link destination for navigation items that lead to this page (see more below)
...
- links can be overridden in the following ways
	...
	- 'link' => [0, 'target page that is not unique', 2], //you can use any mixture of index values and titles however this isn't recommended
