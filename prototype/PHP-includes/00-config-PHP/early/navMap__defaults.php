...
//determines what the default template for the site is (do not remove this but you can change it to a different template if you like)
$GLOBALS['defaultTemplate'] = 'accordion-standard';
...
$GLOBALS['navMap__defaults'] = array(
	...
	'subTemplate' => $GLOBALS['defaultTemplate'],
