...
for (var key in JS_merge_files) {
  if (JS_merge_files.hasOwnProperty(key)) {
  	...
  	JS_minified_files['theme/assets/js/ZZ-merged-JS/'+key+'.min.js'] = ['theme/assets/js/ZZ-merged-JS/'+key+'.js'];
  }
}
...
//	5.	You’re done, it should be working now :)
		...
		sprite:{
	        ...
	        retina: {
	            src: 'theme/assets/images/auto-sprite/HD-retina-sourcefiles/*.png',
	            dest: 'theme/assets/images/auto-sprite/HD-retina-autosprite.png',
	            destCss: 'theme/assets/sass/00-config/sprite-sheets/HD-retina-sprites.scss',
	            cssFormat: 'scss_maps',
			...
			nonRetina: {
	            src: 'theme/assets/images/auto-sprite/LD-nonRetina-sourceFiles/*.png',
	            dest: 'theme/assets/images/auto-sprite/LD-nonRetina-autosprite.png',
	            destCss: 'theme/assets/sass/00-config/sprite-sheets/LD-nonRetina-sprites.scss',
	            cssFormat: 'scss_maps',
		...
		sass_globbing: {
			all: {
				files: {
					'theme/assets/sass/import-maps/map-functions.scss': 'theme/assets/sass/00-functions-SASS/**/*.scss',
					'theme/assets/sass/import-maps/map-config.scss': 'theme/assets/sass/01-config-SASS/**/*.scss',
					'theme/assets/sass/import-maps/map-mixins.scss': 'theme/assets/sass/02-mixins-SASS/**/*.scss',
					'theme/assets/sass/import-maps/map-plugins.scss': 'theme/assets/sass/03-plugins-SASS/**/*.scss',
					'theme/assets/sass/import-maps/map-base.scss': 'theme/assets/sass/04-base-SASS/**/*.scss',
					'theme/assets/sass/import-maps/map-modules.scss': 'theme/assets/sass/05-modules-SASS/**/*.scss',
				}
			}
		},
		...
		sass: {
			...
			modern: {//only compile the modern style sheet
				files: {
					//Modern style sheet
					"theme/assets/css/modern.css": "theme/assets/sass/output-files/modern.scss",
				}
			},
			ie9 : {
				files : {
					//IE9 style sheet
					"theme/assets/css/ie9.css": "theme/assets/sass/output-files/ie9.scss",
				}
			},
			ie8 : {
				files : {
					//IE8 style sheet
					"theme/assets/css/ie8.css": "theme/assets/sass/output-files/ie8.scss",
				}
			}
		},
		...
		cmq: {
			your_target: {
				files: {
					'theme/assets/css/media-merge/': [
						'theme/assets/css/modern.css',
		...
		csso: {
		  minify: {
			...
			//takes the current css files in the "media-merge" folder, minifies them, adds '.min.css' to the end of the file, and copies them back into the main css folder
		      expand: true,
		      cwd: 'theme/assets/css/media-merge/',
			...
			js: {
				files: [
					// includes files within path
					{
						cwd: 'theme/assets/js/',
						src: ['ZZ-merged-JS/*.js'],
						dest: server_root + 'theme/assets/js/',
					}
				],
				...
				files: [
					{
						...
						src: ['*.css', '*.map'],
						dest: server_root + 'theme/assets/css/'
					}
				],
				//pretend: true,
				verbose: true
				...
				files: [
					{
						...
						src: ['**/**'],
						dest: server_root + 'theme/assets/fonts/'
					}
				],
				//pretend: true,
				verbose: true
		...
		watch: {
			...
			scripts: {
				files: ["theme/assets/js/**/*.js", "!theme/assets/js/ZZ-merged-JS/*.js"],
				tasks: [
